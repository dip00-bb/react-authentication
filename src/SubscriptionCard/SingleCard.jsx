    ...
    return (
        <div className="bg-[#1c1c1e] text-white rounded-2xl p-4 w-80 shadow-lg group hover:shadow-xl transition-shadow duration-300 mx-auto h-fit">
            ...
            <div className="mt-4 space-y-2 text-center">
                ...
                <Link to={`/platform/${id}`} className="mt-3 px-4 py-2 bg-gradient-to-r from-red-500 to-purple-600 text-white rounded-full shadow-md hover:scale-105 transition-transform duration-300">
                    View More
                </Link>
            </div>
        </div>
