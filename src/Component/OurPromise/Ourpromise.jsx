...
const Ourpromise = () => {
    return (
        <div className="flex flex-col md:flex-row items-center gap-10 bg-gray-900 text-white px-6 py-12 rounded-2xl shadow-lg">
            ...
            <div className="md:w-1/2 w-full">
                ...
                <p className="text-lg leading-relaxed text-gray-300">
                    Welcome to <span className="text-white font-semibold">MovieSub Hub</span>, the easiest and most affordable way to enjoy your favorite streaming platforms. Whether it's <span className="text-white font-medium">Netflix, Amazon Prime, Disney+</span>, or any other popular movie and TV subscription, we bring them all together in one place—just for you.
                    <br /><br />
