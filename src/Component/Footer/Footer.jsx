...
export default function Footer() {
  ...
  return (
    <div className="w-full ">
      ...
      <div className="h-1 w-full bg-gradient-to-r from-pink-500 via-yellow-500 via-green-500 via-blue-500 to-purple-500 animate-border" />

      <footer className="flex flex-col md:flex-row justify-between text-white py-10 px-6 bg-black md:px-10">
        <div className="flex flex-col space-y-6 md:w-1/2">
          ...
          <div>
            <h4 className="text-lg font-semibold">Connect with LavaROX</h4>
          ...
          <p className="text-xs text-gray-500">© 2025 LavaROX</p>
          <p className="text-xs text-gray-400">Watch for free with your participating library card or on a 30-day trial or rent with a personal LavaROX account.</p>
        </div>

        <div className="flex flex-col items-center mt-10 md:mt-0 ">
          <h4 className="text-lg font-semibold">Get the free LavaROX apps</h4>
          <p className="text-sm text-gray-400 text-center mb-4">Stream award-winning films to your favorite devices</p>
